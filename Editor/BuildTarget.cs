...
namespace BuildMultiPlatform
{
	...
	public class BuildTarget : ICloneable
	{
		...
		[SerializeField, Tooltip("Specified subtarget.")]
		public UnityEditor.StandaloneBuildSubtarget subtarget = UnityEditor.StandaloneBuildSubtarget.Player;
#endif
